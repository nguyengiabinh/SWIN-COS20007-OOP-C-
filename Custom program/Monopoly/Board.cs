...
namespace Monopoly
{
    public class Board
    {
        ...
        {
            CardFetch cardtype1 = new CardFetch(card_Type.Chance);
            CardFetch cardtype2 = new CardFetch(card_Type.Community_Chest);
            ...
            square[3] = cardtype1.FetchSquare(3);
            square[4] = new Property("Tay Ho Rift", property_Type.Mansion, 120, 0, Property_Status.Sale, null, 4);
            ...
            square[8] = cardtype1.FetchSquare(8);
            ...
            square[12] = cardtype2.FetchSquare(12);
